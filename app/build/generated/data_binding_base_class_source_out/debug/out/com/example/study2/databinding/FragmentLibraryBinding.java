...
package com.example.study2.databinding;
...
public final class FragmentLibraryBinding implements ViewBinding {
  ...
  private FragmentLibraryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentLibraryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLibraryBinding((ConstraintLayout) rootView, imageView);
    }
