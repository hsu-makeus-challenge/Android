...
public final class FragmentUploadBinding implements ViewBinding {
  ...
  private FragmentUploadBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentUploadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUploadBinding((ConstraintLayout) rootView, imageView);
    }
